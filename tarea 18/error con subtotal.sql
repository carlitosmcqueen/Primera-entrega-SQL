...
CREATE TABLE `cliente_contacto` (
  ...
  CONSTRAINT `cliente_contacto_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id`)
...
--
-- Table structure for table `historial_tratamientos`
--

DROP TABLE IF EXISTS `historial_tratamientos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `historial_tratamientos` (
  ...
  CONSTRAINT `historial_tratamientos_ibfk_1` FOREIGN KEY (`id_tratamiento`) REFERENCES `tratamiento` (`id`),
  CONSTRAINT `historial_tratamientos_ibfk_2` FOREIGN KEY (`id_animal`) REFERENCES `animal` (`id`)
...
INSERT INTO `historial_tratamientos` VALUES (1,5,6,'2023-06-03','04:17:08'),(2,6,7,'2023-06-04','04:18:08'),(3,7,9,'2023-06-12','19:57:11'),(4,8,3,'2023-07-12','19:57:30'),(5,10,1,'2023-07-12','20:19:10'),(7,11,1,'2023-07-17','23:32:50');
...
CREATE TABLE `mascotas` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_animal` (`id_animal`),
  KEY `mascotas_ibfk_1` (`id_cliente`),
...
--
-- Table structure for table `provedor_contacto`
--

DROP TABLE IF EXISTS `provedor_contacto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
INSERT INTO `ticket_venta_temporal` VALUES (133,1,11,1,NULL),(134,1,11,4,NULL);
...
--
-- Table structure for table `trabajadores_contacto`
--

DROP TABLE IF EXISTS `trabajadores_contacto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `tratamiento` (
  ...
  CONSTRAINT `id_personal` FOREIGN KEY (`id_personal`) REFERENCES `personal_tratamiento` (`id`),
...
--
-- Temporary view structure for view `view_mercaderia`
--

DROP TABLE IF EXISTS `view_mercaderia`;
/*!50001 DROP VIEW IF EXISTS `view_mercaderia`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_mercaderia` AS SELECT 
 1 AS `nombre`,
 1 AS `stock_total`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `view_mercaderia`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_mercaderia` AS select `mercaderia`.`nombre` AS `nombre`,sum(`mercaderia`.`stock`) AS `stock_total` from `mercaderia` group by `mercaderia`.`nombre` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-08-13 19:27:15
